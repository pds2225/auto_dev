...
- [x] [TASK-48] UI에서 야간 루프 모드 선택 추가
  - 원본 태스크: TASK-48
  - 의존성: 없음
  - 검증: 밤샘 루프 모드 설정 후 UI 테스트 수행

- [x] [TASK-49] 밤샘 루프 관련 API 엔드포인트 개발
  - 원본 태스크: TASK-49
  - 의존성: 없음
  - 검증: Postman을 통해 API 호출 테스트 실행

- [x] [TASK-50] 밤샘 루프 모드 로직 구현
  - 원본 태스크: TASK-50
  - 의존성: 없음
  - 검증: 부하 테스트 도구를 사용하여 성능 모니터링

- [x] [TASK-51] 밤샘 루프 모드 테스트 케이스 작성
  - 원본 태스크: TASK-51
  - 의존성: 없음
  - 검증: CI/CD 파이프라인에서 테스트 실행 및 결과 확인

- [x] [TASK-52] 밤샘 루프 모드 UI 구현
  - 원본 태스크: TASK-52
  - 의존성: 없음
  - 검증: UI 테스트를 통해 사용자 인터페이스 검증

- [x] [TASK-53] 루프 모드 로직 개발
  - 원본 태스크: TASK-53
  - 의존성: 없음
  - 검증: API 테스트 도구를 이용하여 기능 검증

- [x] [TASK-54] 밤샘 루프 모드 통합 테스트
  - 원본 태스크: TASK-54
  - 의존성: 없음
  - 검증: 테스트 자동화 도구를 이용하여 결과 확인

- [x] [TASK-55] 디버깅 및 오류 수정
  - 원본 태스크: TASK-55
  - 의존성: 없음
  - 검증: 디버깅 툴과 프로파일링 도구로 성능 및 오류 확인
## Waiting On
